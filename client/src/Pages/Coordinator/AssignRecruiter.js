            ...
            <div className='bg-[#e7e7e7] py-8 px-4 lg:px-16 rounded-lg'>
                ...
                <form onSubmit={handleSubmit(onSubmit)} >
                    <div className='flex flex-col lg:flex-row  gap-8'>
                            ...
                            <div className='lg:w-1/2 w-full'>
                                ...
                                <div className='my-4 gap-2 grid grid-cols-2 mx-0 md:mx-8 lg:mx-0'>
                                    ...
                                    <div className='bg-green-300 rounded-lg py-4 md:py-5 text-center'>
                                        <h2 className='text-xs md:text-md font-semibold text-gray-700'>Vị trí công việc</h2><p className='text-sm md:text-lg font-bold'>{job.jobTitle }</p>
                                    </div>
                                ...
                                {/* JOB DESCRIPTION */}
                                <div className='px-1'>
                                    <h2 className='my-2 text-sm font-bold'>Mô tả công việc</h2>
                                ...
                                <div className='mt-4  md:mx-0'>
                                    <div>
                                        <label className='block mt-2 m-1 text-sm font-bold '>Phân công nhà tuyển dụng</label>
                        ...
                        <div className='lg:w-1/2 w-full md:mt-0'>
                            <div className='text-center'>
                                <h1 className='text-lg md:text-xl font-bold'>Tạo biểu mẫu phản hồi</h1>
                                <p className='text-xs mb-6 italic' >Câu hỏi chỉ cho phép trả lời có/không.</p>
                            </div>
                    ...
                    <div className='flex justify-center mt-8'>
                        <button className='block bg-primary text-white text-md font-medium py-3 px-16 rounded-md hover:opacity-90 transition-opacity shadow-md hover:shadow-lg'>Phê duyệt bài đăng việc làm</button>
                    </div>
                </form>

                                ...
                                <div className="rounded-t mb-0 px-4 py-3 border-0 bg-secondary text-white ">
                                    <div className="flex flex-wrap items-center">
                                        <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-center">
                                            <h3 className="font-bold text-base text-blueGray-700">Phê duyệt việc làm - Phân công nhà tuyển dụng</h3>
                                        </div>
                                    ...
                                    <table className="items-center bg-transparent w-full border-collapse ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th className={tableHeaderCss}>Phân công</th>
        ...
        <tr>
            ...
            <td className={`flex justify-between ${tableDataCss}`}>
                <Link to={`/assign-recruiter/${job._id}`}>
                    <button className='block bg-primary text-white mx-auto text-md font-medium py-2 px-5 md:px-6 rounded-md hover:opacity-90 transition-opacity shadow-sm hover:shadow-md'>Phê duyệt</button>
                </Link>
            </td>
        </tr>
    )

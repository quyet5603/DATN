...
export const UpdateJob = () => {
        ...
        fetch(`http://localhost:8080/jobs/current-job/${id}`, {
            ...
            .then((result) => {
                ...
                reset({
                    ...
                    deadline: result.deadline ? new Date(result.deadline).toISOString().split('T')[0] : '',
                    educationRequirement: result.educationRequirement || '',
                    experienceRequirement: result.experienceRequirement || '',
                    genderRequirement: result.genderRequirement || '',
    ...
    const onSubmit = (data) => {
        ...
        fetch(`http://localhost:8080/jobs/update-job/${id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div className='min-h-screen bg-gray-50 py-8'>
            <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
                {/* Header */}
                <div className='mb-8'>
                    <p className='text-sm text-blue-600 font-medium mb-2'>CẬP NHẬT TIN TUYỂN DỤNG</p>
                    <h1 className='text-3xl md:text-4xl font-bold text-gray-900 mb-3'>Chỉnh sửa tin tuyển dụng</h1>

                                ...
                                <div className="rounded-t mb-0 px-4 py-3 border-0 bg-secondary text-white ">
                                    <div className="flex flex-wrap items-center">
                                        <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-center">
                                            <h3 className="font-bold text-base text-blueGray-700">Xem xét ứng viên</h3>
                                        </div>
                                    ...
                                    <table className="items-center bg-transparent w-full border-collapse ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th className={tableHeaderCss}>Đơn ứng tuyển</th>
                                            </tr>
                                        </thead>
                                        <tbody>
        ...
        <tr>
            ...
            <td className={`${tableDataCss}`}>
                <Link to={`/candidate/${applicant._id}`} >
                    <button className='block bg-primary text-white mx-auto text-md py-2  px-5 md:px-6 rounded-md'> Xem xét</button>
                </Link>
            </td>
        </tr>
    )

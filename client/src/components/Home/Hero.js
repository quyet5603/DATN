      ...
      <div className='max-w-screen-2xl container mx-auto px-4 md:py-12 py-8'>
        <div className='flex justify-center items-center min-h-[400px]'>
          <div className='text-center max-w-3xl'>
            ...
            <button className='bg-secondary text-white py-3 px-10 md:px-12 rounded-md text-lg font-medium hover:opacity-90 transition-opacity shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform'>Bắt đầu ngay</button>
          </div>
        </div>

                            ...
                            <div>

                                    {
                                        ...
                                        <div className='grid grid-cols-1 gap-4 mt-4'>
                                            <div>
                                                <h1 className='italic text-md md:text-lg font-bold text-gray-500'>Chi tiết ứng viên</h1>
                                                <div className='px-1'>
                                                    ...
                                                    <p className='text-sm md:text-base text-justify '>Địa chỉ: {candidate.address}</p>
                                                    <p className='text-sm md:text-base text-justify '>CV: {candidate.address}</p>
                                                </div>
                                            </div>

                                            <div>
                                                <h1 className='italic text-md md:text-lg font-bold text-gray-500'>Chi tiết vị trí công việc</h1>
                                                <div className='px-1'>
                                                    <h2 className='text-md font-bold'>Vị trí : {job.jobTitle}</h2>
                                                    <p className='text-sm md:text-base text-justify '>Địa điểm: {job.location}</p>
                                                    <p className='text-sm md:text-base text-justify '>Loại: {job.employmentType}</p>
                                            ...
                                            <div>
                                                <h1 className='italic text-md md:text-lg font-bold text-gray-500'>Phản hồi ứng viên</h1>
                                                <div className='px-1'>
